...
public final class ValidationMatchers {
    ...
    public static <T> Matcher<Class<T>> hasDecimalMaxAnnotation(String fieldName, String value) {
        return hasDecimalMaxAnnotation(fieldName, AnnotationMap.from(DecimalMax.class).set("value", value));
    }

    public static <T> Matcher<Class<T>> hasDecimalMaxAnnotation(String fieldName, String value, boolean inclusive) {
        return hasDecimalMaxAnnotation(fieldName, AnnotationMap.from(DecimalMax.class).set("value", value).set("inclusive", inclusive));
    }
    ...
    public static <T> Matcher<Class<T>> hasDecimalMinAnnotation(String fieldName, String value) {
        return hasDecimalMinAnnotation(fieldName, AnnotationMap.from(DecimalMin.class).set("value", value));
    }

    public static <T> Matcher<Class<T>> hasDecimalMinAnnotation(String fieldName, String value, boolean inclusive) {
        return hasDecimalMinAnnotation(fieldName, AnnotationMap.from(DecimalMin.class).set("value", value).set("inclusive", inclusive));
    }
    ...
    public static <T> Matcher<Class<T>> hasDigitsAnnotation(String fieldName, int integer, int fraction) {
        return hasDigitsAnnotation(fieldName, AnnotationMap.from(Digits.class).set("integer", integer).set("fraction", fraction));
    }
    ...
    public static <T> Matcher<Class<T>> hasLengthAnnotation(String fieldName, int min, int max) {
        return hasLengthAnnotation(fieldName, AnnotationMap.from(Length.class).set("min", min).set("max", max));
    }
    ...
    public static <T> Matcher<Class<T>> hasLuhnCheckAnnotation(String fieldName, int startIndex) {
        return hasLuhnCheckAnnotation(fieldName, AnnotationMap.from(LuhnCheck.class).set("startIndex", startIndex));
    }

    public static <T> Matcher<Class<T>> hasLuhnCheckAnnotation(String fieldName, int startIndex, int endIndex) {
        return hasLuhnCheckAnnotation(fieldName, AnnotationMap.from(LuhnCheck.class).set("startIndex", startIndex).set("endIndex", endIndex));
    }

    public static <T> Matcher<Class<T>> hasLuhnCheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex) {
        return hasLuhnCheckAnnotation(fieldName, AnnotationMap.from(LuhnCheck.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex));
    }

    public static <T> Matcher<Class<T>> hasLuhnCheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters) {
        return hasLuhnCheckAnnotation(fieldName, AnnotationMap.from(LuhnCheck.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters));
    }
    ...
    public static <T> Matcher<Class<T>> hasMod10CheckAnnotation(String fieldName, int startIndex) {
        return hasMod10CheckAnnotation(fieldName, AnnotationMap.from(Mod10Check.class).set("startIndex", startIndex));
    }

    public static <T> Matcher<Class<T>> hasMod10CheckAnnotation(String fieldName, int startIndex, int endIndex) {
        return hasMod10CheckAnnotation(fieldName, AnnotationMap.from(Mod10Check.class).set("startIndex", startIndex).set("endIndex", endIndex));
    }

    public static <T> Matcher<Class<T>> hasMod10CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex) {
        return hasMod10CheckAnnotation(fieldName, AnnotationMap.from(Mod10Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex));
    }

    public static <T> Matcher<Class<T>> hasMod10CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters) {
        return hasMod10CheckAnnotation(fieldName, AnnotationMap.from(Mod10Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters));
    }

    public static <T> Matcher<Class<T>> hasMod10CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters, int multiplier) {
        return hasMod10CheckAnnotation(fieldName, AnnotationMap.from(Mod10Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters).set("multiplier", multiplier));
    }

    public static <T> Matcher<Class<T>> hasMod10CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters, int multiplier, int weight) {
        return hasMod10CheckAnnotation(fieldName, AnnotationMap.from(Mod10Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters).set("multiplier", multiplier).set("weight", weight));
    }
    ...
    public static <T> Matcher<Class<T>> hasMod11CheckAnnotation(String fieldName, int startIndex) {
        return hasMod11CheckAnnotation(fieldName, AnnotationMap.from(Mod11Check.class).set("startIndex", startIndex));
    }

    public static <T> Matcher<Class<T>> hasMod11CheckAnnotation(String fieldName, int startIndex, int endIndex) {
        return hasMod11CheckAnnotation(fieldName, AnnotationMap.from(Mod11Check.class).set("startIndex", startIndex).set("endIndex", endIndex));
    }

    public static <T> Matcher<Class<T>> hasMod11CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex) {
        return hasMod11CheckAnnotation(fieldName, AnnotationMap.from(Mod11Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex));
    }

    public static <T> Matcher<Class<T>> hasMod11CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters) {
        return hasMod11CheckAnnotation(fieldName, AnnotationMap.from(Mod11Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters));
    }

    public static <T> Matcher<Class<T>> hasMod11CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters, int threshold) {
        return hasMod11CheckAnnotation(fieldName, AnnotationMap.from(Mod11Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters).set("threshold", threshold));
    }

    public static <T> Matcher<Class<T>> hasMod11CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters, int threshold, char treatCheck10As) {
        return hasMod11CheckAnnotation(fieldName, AnnotationMap.from(Mod11Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters).set("threshold", threshold).set("treatCheck10As", treatCheck10As));
    }

    public static <T> Matcher<Class<T>> hasMod11CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters, int threshold, char treatCheck10As, char treatCheck11As) {
        return hasMod11CheckAnnotation(fieldName, AnnotationMap.from(Mod11Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters).set("threshold", threshold).set("treatCheck10As", treatCheck10As).set("treatCheck11As", treatCheck11As));
    }

    public static <T> Matcher<Class<T>> hasMod11CheckAnnotation(String fieldName, int startIndex, int endIndex, int checkDigitIndex, boolean ignoreNonDigitCharacters, int threshold, char treatCheck10As, char treatCheck11As, ProcessingDirection processingDirection) {
        return hasMod11CheckAnnotation(fieldName, AnnotationMap.from(Mod11Check.class).set("startIndex", startIndex).set("endIndex", endIndex).set("checkDigitIndex", checkDigitIndex).set("ignoreNonDigitCharacters", ignoreNonDigitCharacters).set("threshold", threshold).set("treatCheck10As", treatCheck10As).set("treatCheck11As", treatCheck11As).set("processingDirection", processingDirection));
    }
    ...
    public static <T> Matcher<Class<T>> hasPatternAnnotation(String fieldName, String regexp, Flag... flags) {
        return hasPatternAnnotation(fieldName, AnnotationMap.from(Pattern.class).set("regexp", regexp).set("flags", flags));
    }
    ...
    public static <T> Matcher<Class<T>> hasRangeAnnotation(String fieldName, long min, long max) {
        return hasRangeAnnotation(fieldName, AnnotationMap.from(Range.class).set("min", min).set("max", max));
    }
    ...
    public static <T> Matcher<Class<T>> hasSafeHtmlAnnotation(String fieldName, WhiteListType whitelistType) {
        return hasSafeHtmlAnnotation(fieldName, AnnotationMap.from(SafeHtml.class).set("whitelistType", whitelistType));
    }

    public static <T> Matcher<Class<T>> hasSafeHtmlAnnotation(String fieldName, WhiteListType whitelistType, String... additionalTags) {
        return hasSafeHtmlAnnotation(fieldName, AnnotationMap.from(SafeHtml.class).set("whitelistType", whitelistType).set("additionalTags", additionalTags));
    }
    ...
    public static <T> Matcher<Class<T>> hasScriptAssertAnnotation(String script, String lang) {
        return hasScriptAssertAnnotation(AnnotationMap.from(ScriptAssert.class).set("script", script).set("lang", lang));
    }

    public static <T> Matcher<Class<T>> hasScriptAssertAnnotation(String script, String lang, String alias) {
        return hasScriptAssertAnnotation(AnnotationMap.from(ScriptAssert.class).set("script", script).set("lang", lang).set("alias", alias));
    }
    ...
    public static <T> Matcher<Class<T>> hasSizeAnnotation(String fieldName, int min, int max) {
        return hasSizeAnnotation(fieldName, AnnotationMap.from(Size.class).set("min", min).set("max", max));
    }
    ...
    public static <T> Matcher<Class<T>> hasUrlAnnotation(String fieldName, String protocol, String host) {
        return hasUrlAnnotation(fieldName, AnnotationMap.from(URL.class).set("protocol", protocol).set("host", host));
    }

    public static <T> Matcher<Class<T>> hasUrlAnnotation(String fieldName, String protocol, String host, int port) {
        return hasUrlAnnotation(fieldName, AnnotationMap.from(URL.class).set("protocol", protocol).set("host", host).set("port", port));
    }
